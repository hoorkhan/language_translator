...
class LanguagTranslationPage extends StatefulWidget {
  const LanguagTranslationPage({super.key});

  @override
  State<LanguagTranslationPage> createState() => _LanguagTranslationPageState();
}

class _LanguagTranslationPageState extends State<LanguagTranslationPage> {
          ...
          child: Column(
            children: [
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(backgroundColor: const Color(0xff2b3c5a)),
                  onPressed: (){
